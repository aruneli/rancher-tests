...
class TestLbserviceActivateLbActivateSvcLink:

    tname = "TestLbserviceActivateLbActivateSvcLink"

    @pytest.mark.create
    @pytest.mark.run(order=1)
    def test_lbservice_activate_lb_activate_svc_link_create(
    ...
    def test_lbservice_activate_lb_activate_svc_link(super_client, client, socat_containers):
